<footer>
	<div class="wrapper">
		<div id="goTop">
			<img src="../image/au.svg" alt="go top">
		</div>
		<div class="list">
			<ul>
				<li>
			...
			<ul>
				...
				<li>
					<a href="../achievement-bridge">橋墩基礎＆船甲板＆車底...</a>
				</li>
				<li>
				...
				<li>
					<a href="../achievement-anti-corrosion">防腐蝕</a>
				</li>
			</ul>
			<ul>
				<li>
		...
		<div class="bottom">
			<div class="affirm">
				<p>版權所有 © 易兆企業有限公司 Hydroseal Enterprise Co. Ltd. All Rights Reserved.
				</p>
				<ul>
					<li>
						<a href="">台北市文山區木柵路四段153號6樓</a>
					</li>
					<li class="line"></li>
					<li>
						<a href="">聯絡電話：02-2239-0262</a>
					</li>
					<li class="line"></li>
					<li>
						<a href="">傳真：02-2239-0272</a>
					</li>
					<li class="line"></li>
					<li>
						<a href="">E-mail：info@hydroseal.com.tw</a>
					</li>
				</ul>
				<ol>
					<li>
